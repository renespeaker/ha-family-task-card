...
> 🌐 **Deutsch** (diese Seite) · [English](ROADMAP.md)
...
- [x] **Fällige Aufgaben in der Family Board Card** – seit Board v0.27 zeigt jene
      Karte fällige Aufgaben aus denselben `todo.*`-Listen als Chips. Beide Karten
      bleiben eigenständig, keine setzt die andere voraus. Offen: nichts geplant –
      eine engere Kopplung würde Einzelinstallationen zerschlagen.
- [ ] Weitere Sprachen (aktuell DE/EN).
- [x] **Englische Dokumentation** – README und Roadmap sind englisch zuerst, die
